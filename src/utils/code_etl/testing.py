...
code_lines = sqlCtx.read.option("multiLine", True).option("mode", "PERMISSIVE").json(os.getcwd() + "\jsons\hi.json")
...
word2vec = Word2Vec()
word2vec.setMinCount(2)    # Must be at least x occurrences of a word to produce a vector.
